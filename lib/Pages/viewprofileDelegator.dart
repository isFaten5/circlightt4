...
class ViewprofileDelegator extends StatefulWidget {
  var isChanged = "";
  ...
  @override
  State<ViewprofileDelegator> createState() => _ViewprofileDelegator();
  getData(change) {
    isChanged = change;
  }
}

class _ViewprofileDelegator extends State<ViewprofileDelegator>
    ...
    return AlertDialog(
      ...
      actions: <Widget>[
        TextButton(
            onPressed: () {
              Navigator.of(context).push(CupertinoPageRoute(
                  builder: (context) => DelegatorHome(userName: '', user: "")));
            },
